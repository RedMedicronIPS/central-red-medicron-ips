...
export default function ReconocimientosPage() {
    ...
    const getProfilePicUrl = (foto: string) => {
        ...
        const baseUrl = import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000' || 'http://152.200.161.234:8081/' ;
        return `${baseUrl}${foto}`;
    };
    ...
    if (loading) {
        return (
            <div className="min-h-screen relative overflow-hidden">
                {/* Fondo decorativo */}
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"></div>
                ...
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-orange-400/10 to-yellow-400/10 rounded-full blur-3xl"></div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="animate-pulse space-y-6">
                            ...
                            <div className="space-y-4">
                                {[...Array(6)].map((_, i) => (
                                    <div key={i} className="h-32 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-gray-700/50"></div>
                                ))}
                            </div>
                        </div>
                    </div>
