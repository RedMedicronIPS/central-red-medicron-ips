...
export default function TiposProceso() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isEditing && form.id) {
                const response = await axiosInstance.put(`/process-types/${form.id}/`, form);
                ...
                const response = await axiosInstance.post("/process-types/", form);
    ...
    const confirmDelete = async () => {
        ...
        try {
            await axiosInstance.delete(`/process-types/${processTypeIdToDelete}/`);
    ...
    const confirmToggleStatus = async () => {
        ...
        try {
            const response = await axiosInstance.patch(`/process-types/${processTypeToToggle.id}/`, {
